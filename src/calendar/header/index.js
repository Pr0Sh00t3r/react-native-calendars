...
//import all supported locale data
...
class CalendarHeader extends Component {
  ...
  render() {
    ...
    let heading = this.props.month.toString(this.props.monthFormat)

    const locale = _.get(this.props, "locale", "en")
    if (locale !== "en") {
      heading = new Intl.DateTimeFormat(this.props.locale, {
        year: "numeric",
        month: "long"
      }).format(this.props.month)
    }
